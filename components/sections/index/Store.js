                  ...
                  <div className="why-choose-one__content">
                     <div className="sec-title center text-center tg-heading-subheading animation-style2">
                        ...
                        <h2 className="sec-title__title tg-element-title">
                           ...
                           {st("sub_title1")} <br />{" "}
                           <span> {st("sub_title2")} </span> {st("sub_title3")}{" "}
                           <span> {st("sub_title4")} </span>
                        </h2>
                     </div>
                  </div>
               </div>
                        ...
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand01.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand02.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand03.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand05.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand06.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           ...
                           >
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand07.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
                     ...
                     <div className="brand-one__single text-center">
                        <div className="brand-one__single-inner">
                           <Link href="#">
                              <div className="brand-one__image">
                                 <img
                                    src="assets/images/brand/brand08.svg"
                                    alt=""
                                 />
                              </div>
                              <div>
