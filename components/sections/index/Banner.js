  ...
  return (
    <>
      <section className="slider-one">
        <div className="slider-one__pattern">
          <Swiper
            {...swiperOptions}
            ...
            <SwiperSlide>
              <div className="slider-one__single">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/images/banner/banner1.png)",
                  }}
                ></div>
            ...
            <SwiperSlide>
              <div className="slider-one__single">
                <div
                  className="slider-one__single-bg"
                  style={{
                    backgroundImage: "url(assets/images/banner/banner2.png)",
                  }}
                ></div>
                <div className="shape1"></div>
                <div className="shape2"></div>
            ...
            <SwiperSlide>
              <div className="slider-one__single">
                <div
                  className="slider-one__single-bg"
                  style={{
                    backgroundImage: "url(assets/images/banner/banner3.png)",
                  }}
                ></div>
                <div className="shape1"></div>
                <div className="shape2"></div>
            ...
            <SwiperSlide>
              <div className="slider-one__single">
                <div
                  className="slider-one__single-bg"
                  style={{
                    backgroundImage: "url(assets/images/banner/banner4.png)",
                  }}
                ></div>
                <div className="shape1"></div>
                <div className="shape2"></div>
            ...
            <SwiperSlide>
              <div className="slider-one__single">
                <div
                  className="slider-one__single-bg"
                  style={{
                    backgroundImage: "url(assets/images/banner/banner5.png)",
                  }}
                ></div>
                <div className="shape1"></div>
                <div className="shape2"></div>
